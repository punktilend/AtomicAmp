...
AtomicAmp collects nothing, stores nothing about you, and sends nothing anywhere. It has no
internet permission, so it is not technically capable of transmitting your data even if it wanted
to.
...
| **Receive boot completed** | Optional. If "Resume playing when the car starts" is enabled, this lets playback resume after the device powers on. It can be turned off in the app. |
